...
$APPLICATION->SetPageProperty( 'description', 'Рейтинги лучших предложений популярных банков. Подборка лучших предложений кредитов, кредитных и дебетовых карт, ипотеки, автострахования и других банковских продуктов. Онлайн рассмотрение заявки. ');
$APPLICATION->SetPageProperty( 'keywords', 'рейтинг, топ, банковских карт');
?><?php
//Фильтр по тегам
if(isset($_GET["tags"]) && !empty($_GET["tags"])){
$GLOBALS["arRegionLink"] = Array("?TAGS" => $_GET["tags"]);
}
?>
 <?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CACHE_TYPE" => "N",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "fm_rait_page",
		...
		"SECTION_ELEMENTS_TYPE_VIEW" => "list_elements_4",
