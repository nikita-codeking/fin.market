...
<?if($itemsCnt):?>
			...
			<?}?>
                ...
                if (isset($_GET["sort"]) && isset($_GET["method"]) && (
                        $_GET["sort"] == "property_OT_DO_PROZ_ST_MAX" || $_GET["sort"] == "property_OT_DO_CREDIT_LIM_MAX" || $_GET["sort"] == "property_OT_DO_LGOTNIY_PERIOD_MAX" || $_GET["sort"] == "property_OT_DO_GOD_OBSL_MAX" || $_GET["sort"] == "property_OT_DO_OBSLUGIVANIE_MAX")){
                    $sort = $_GET["sort"];
                    ...
                    if($pos_credit_cart>0){
                        $sort = "property_OT_DO_CREDIT_LIM_MAX";
                        $sort_order = "desc";
                    }
                    if($pos_credit_nal>0){
                        $sort = "property_OT_DO_PROZ_ST_MAX";
                        $sort_order = "desc";
                    }
                    if($pos_debit_cart>0){
                        $sort = "property_OT_DO_GOD_OBSL_MAX";
                        $sort_order = "desc";
                    }
                    if($pos_rko>0){
                        $sort = "property_OT_DO_OBSLUGIVANIE_MAX";
                        $sort_order = "desc";
                     }
                }
                $listElementsTemplate = "fm_" . $listElementsTemplate;
                ?>
				<?$APPLICATION->IncludeComponent(
