...
if($arResult['ITEMS']){?>
	...
	<span id="<?=$injectId?>_items" class=" bigdata_recommended_products_items flexslider1 loading_state shadow border custom_flex top_right" data-plugin-options='{"animation": "slide", "animationSpeed": 600, "directionNav": true, "controlNav" :false, "animationLoop": true, "slideshow": false, "touch": true,  "counts": [5,4,3,2,1]}'>
