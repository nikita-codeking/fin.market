		...
		<tbody>
			<?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
				<tr>
					...
					<td <?if($propertyID=='NAME'):?>class="main_name_q_input"<?endif;?>>
						...
						<textarea cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]?>" name="PROPERTY[<?=$propertyID?>][<?=$i?>]"><?=$value?></textarea>
							...
							case "N":
                                ...
                                <?php
                                    ...
                                    if($propertyID==345 || $propertyID==347){
                                ...
                                ?>
								<input type="text" <?=$str_class?> name="PROPERTY[<?=$propertyID?>][<?=$i?>]" size="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]; ?>" value="<?=$value?>" placeholder="<?=$placeholder?>"/><br /><?
