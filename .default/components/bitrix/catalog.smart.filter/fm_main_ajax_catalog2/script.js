$(document).ready(function(){
    ...
    setTimeout(function () {
        ...
        $('.new_groups').each(function () {
            $(this).removeAttr("style");
            $(this).attr("style","display:none;");
            $(this).removeClass('active');
        });

        $('.new_groups .bx_filter_block').each(function () {
            $(this).removeAttr("style");
        });
        $('.new_groups_pod').each(function () {
            $(this).parent().addClass('active');
        });
        $('.podgruppa').each(function () {
            $(this).removeAttr("style");
            $(this).attr("style","display:none;");
            $(this).removeClass('active');
        });
    ...
    if($(window).width()<=450){
        $(window).on('scroll',function(){
            ...
            menuFilterPosition =  $('.inner_wrapper').offset().top;
            //console.log(menuFilterPosition);

            if(lastKnownScrollPosition>=menuFilterPosition)
            {
                $('.adaptive_filter').attr("style","    position: -webkit-sticky;position: sticky;top: 0px;width: 100%;");
            }else{
                $('.adaptive_filter').removeAttr("style");
            }
        });
    }
