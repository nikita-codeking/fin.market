...
if($arResult["ITEMS"] && $pos_strahovki===false){?>
    <div class="bx_filter bx_filter_vertical swipeignore 9">
            ...
            <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
                ...
                <div class="bx_filter_parameters">
                    ...
                    foreach($arResult["ITEMS"] as $key=>&$arItem)
                    {
                            ...
                            if($pos_point_in_name>0){
                                ...
                                if($arItem['GROUPS'])
                                {
                                    foreach ($arItem['GROUPS'] as $keyG => $itemGroup):?>
                                        ...
                                        ?>
                                        <?if($elCountGr>0):?>
                                        <div class="bx_filter_parameters_box podgr" data-expanded="N" data-prop_code="" data-property_id="">
                                            ...
                                            <div class="bx_filter_block limited_block new_groups">
                                                ...
                                                foreach ($itemGroup as $elementGroup):
                                                    ...
                                                    if (
                                                        ...
                                                        continue;
                                                    printEl($elementGroup,$arParams,$numVisiblePropValues,$arResult,$APPLICATION,$open_group_filters,$key);
                                                endforeach;
                                                ?>
                            ...
                            <?endif?>
                            <?
                            printEl($arItem,$arParams,$numVisiblePropValues,$arResult,$APPLICATION,$open_group_filters,$key);
                            ?>
...
<?
function printEl($arItem,$arParams,$numVisiblePropValues,$arResult,$APPLICATION,$open_group_filters,$key)
{
    $style="";
    if($arItem["CODE"]=="IN_STOCK"){
