...
if($arResult["ITEMS"]){?>
	<div class="bx_filter bx_filter_vertical swipeignore 5">
			...
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter" id="smartfilter<?=$arParams['AJAX_FILTER_FLAG'];?>">
				...
				<div class="bx_filter_parameters">
					...
					foreach($arResult["ITEMS"] as $key=>$arItem)
					{
                        ...
                        <?php
                        //CODEKING - START
                        $mainGroup = $arItem['MAIN_GROUP'];
                        if(strlen($mainGroup)>0 && $oldMainGroup!=$mainGroup):?>
                            <?if(strlen($oldMainGroup)>0):?>
                                            <div class="clb"></div>
                                        </div><!--.bx_filter_block.limited_block-->
                                    </div><!--.bx_filter_block.limited_block.new_groups-->
                                </div><!--.bx_filter_parameters_box.main_parent-->
                            <?endif;?>
                            <div class="bx_filter_parameters_box main_parent" data-expanded="N" data-prop_code="" data-property_id="">
						...
						<div class="bx_filter_parameters_box <?=$class;?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code=<?=strtolower($arItem["CODE"]);?> data-property_id="<?=$arItem["ID"]?>">
                            ...
                            if(isset($arItem['PODGR']))
                            {
                                if(strlen($arItem['PODGR'])>0)
                                {
                                    $loadGroups = true;
                                    ?>
                                    <div class="prop_horizont podgr"><?=$arItem['PODGR']?></div>
                                    <?
                                }//if(strlen($arItem['GROUPS'])>0)
                            }//if(isset($arItem['GROUPS']))
                            ?>
                            <?
                            //CODEKING - END
                            ...
                            <?if($loadGroups==false):?>
								...
								<div class="bx_filter_parameters_box_container <?=($arItem["DISPLAY_TYPE"]=="G" ? "pict_block" : "");?>">
                                    ...
                                    //CODEKING - START
                                    ?>
                                    <?$viewTitleProperty = true;?>
                                    <?foreach($arItem["VALUES"] as $val => $ar):?>
                                        <?if($ar["VALUE"]=="Да" || $ar["VALUE"]=="да"):?>
                                        <?
                                        $viewTitleProperty = false;
                                        break;
                                        ?>
                                        <?endif;?>
                                    <?endforeach;?>
                                    <?if($viewTitleProperty==true):?>
                                        <?
                                        $edIzm = "";
                                        ...
                                        ?>
                                        <div class="prop_horizont"><?=$arItem["NAME"]?><?if(strlen($edIzm)>0):?>, <?=$edIzm?><?endif;?></div>
                                    <?endif;?>
                                    <?
                                    //CODEKING - END
                                    ?>
                                    ...
                                    switch ($arItem["DISPLAY_TYPE"]){
                                            ...
                                            <div class="wrapp_all_inputs wrap_md">
                                                        ...
                                                        <div class="bx_filter_input_container form-control bg">
                                                            <input
                                                                ...
                                                                if($arParams['SECTION_ID'] == 325){
                                                                   ...
                                                                   elseif($arParams['SECTION_ID'] == 331){
                                                                       if($arItem['CODE'] == 'USLOVIYA_M_PROTSENTNAYA_STAVKA_PROTSENT'):
                                                                            echo round($value5, 1);
                                                                       else:
                                                                            echo $value5;
                                                ...
                                                <div class="wrapp_slider iblock">
                                                    <div class="bx_ui_slider_track" id="drag_track_<?=$key?>">
                                                        ...
                                                        <div class="bx_ui_slider_part last p5"><span><?if($arItem['CODE'] == 'USLOVIYA_PROTSENT_ZA_SNYATIE_NALICHNYKH'): echo round($value5, 1); elseif($arItem['CODE'] == 'USLOVIYA_PLATA_ZA_PROPUSK_PLATEZHA_'): echo round($value5, 2); elseif($arItem['CODE'] == 'USLOVIYA_M_PROTSENTNAYA_STAVKA_NA_POKUPKI'): echo round($value5, 2); else: echo $value5; endif;?></span></div>
                                        ...
                                        default://CHECKBOXES
                                            ...
                                            <?foreach($arItem["VALUES"] as $val => $ar):?>
                                                ...
                                                //CODEKING - START
                                                ?>
                                                <?if($ar["VALUE"]=="Да" || $ar["VALUE"]=="да") break; ?>
                                                <?
                                                //CODEKING - END
                                                ?>
                                            <?endforeach;?>
