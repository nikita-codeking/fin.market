...
$(document).ready(function (){
	...
	var fastViewSwiper = new Swiper('#fast_view_item .da-props', {
		spaceBetween: 15,
		slidesPerGroup: 3,
		slidesPerView: 'auto',
		watchOverflow: true,
		...
		mousewheel: true,
		navigation: {
			nextEl: ('#fast_view_item .da-props .swiper-button-next'),
			prevEl: ('#fast_view_item .da-props .swiper-button-prev'),
		},
	});
		...
		if (this.config.showSkuProps && !!this.obSkuProps)
		{
			...
			else
			{
				...
				for(var i in this.offers[index].DISPLAY_PROPERTIES)
				{
					...
					if(display_type == "TABLE")
						html += '<tr><td class="char_name"><span class="'+class_block+'">'+hint_block.replace('Условия.','').replace('Требования.','')+'<span>'+this.offers[index].DISPLAY_PROPERTIES[i].NAME+'</span></span></td><td class="char_value"><span>'+this.offers[index].DISPLAY_PROPERTIES[i].VALUE+'</span></td></tr>';
					else
					{
						html = '<div class="char sku_block_prop"><div class="char_name"><span class="'+class_block+'">'+hint_block.replace('Условия.','').replace('Требования.','')+'<span>'+this.offers[index].DISPLAY_PROPERTIES[i].NAME+'</span></span></div><div class="char_value"><span>'+this.offers[index].DISPLAY_PROPERTIES[i].VALUE+'</span></div></div>';
						$(this.obSkuProps).append(html);
					}
                    html = html.replace('Условия.','').replace('Требования.','');
				}
				if(display_type == "TABLE")
