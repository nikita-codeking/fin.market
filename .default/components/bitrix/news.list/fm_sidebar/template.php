		...
		<div class="">
			<ul class="slides items">
				<?foreach($arResult["ITEMS"] as $arItem):?>
                    ...
                    $arFileTmp = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"]['ID'], array("width" => 285, "height" => 160), BX_RESIZE_IMAGE_EXACT,true);
					$imageSrc = ($bImage ? $arFileTmp["src"] : SITE_TEMPLATE_PATH.'/images/noimage_product.png');
