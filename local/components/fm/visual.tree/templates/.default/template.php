                                        ...
                                        if($sectionItem['ITEMS']):
                                            foreach ($sectionItem['ITEMS'] as $keyS=>$elItem)
                                            {
                                                ...
                                                while($itemResProduct = $resProduct->Fetch())
                                                {
                                                    ...
                                                    ?>
                                                    <p class="siteMapThirdLevelDir" style="margin-left:60px;padding-top: 10px;margin-top: -30px;"> ----element-- <?=$itemResProduct['NAME']?> -- <a style="color: green;" href="<?=$elItem['URL']?><?=$itemResProduct['CODE']?>"><?=$elItem['URL']?><?=$itemResProduct['CODE']?></a>---- Picture---<img class="mapSitePicture" src="<?=CFile::GetPath($itemResProduct['PREVIEW_PICTURE'])?>"></p>
                                                    <?
                                                }
                                                ...
                                                if($elItem['ITEMS']):
                                                    foreach ($elItem['ITEMS'] as $keyS2=>$thirdItem)
                                                    {
                                                        ...
                                                        while($itemResProduct = $resProduct->Fetch())
                                                        {
                                                            $resize_image = CFile::ResizeImageGet(CFile::GetPath($itemResProduct['PREVIEW_PICTURE']),
                                                                Array("width" => 50, "height" => 30),
                                    ...
                                    <details>
                                        ...
                                        while($itemResProduct = $resProduct->Fetch())
                                        {
                                            $resize_image = CFile::ResizeImageGet(CFile::GetPath($itemResProduct['PREVIEW_PICTURE']),
                                                ...
                                                BX_RESIZE_IMAGE_EXACT, false);
                                            ?>
                                            <p class="siteMapThirdLevelDir" style="margin-left:60px;padding-top: 10px;margin-top: -30px;"> --element-- <?=$itemResProduct['NAME']?> -- <a style="color: green;" href="<?=$sectionItem['URL']?><?=$itemResProduct['CODE']?>"><?=$sectionItem['URL']?><?=$itemResProduct['CODE']?></a>---- Picture---<img class="mapSitePicture" src="<?=CFile::GetPath($itemResProduct['PREVIEW_PICTURE'])?>"></p>
                                            <?
                                        }
                                        ?>
                                    </details>
                                        ...
                                        if(count($arrTreeCatalog)>0)
                                        {
                                            foreach ($arrTreeCatalog as $sectionItem)
                                            {
                                                $resize_image = CFile::ResizeImageGet(CFile::GetPath($itemResProduct['PREVIEW_PICTURE']),
                                                    ...
                                                    BX_RESIZE_IMAGE_EXACT, false);
                                                ?>
                                                <p class="siteMapThirdLevelDir" style="margin-left:60px;padding-top: 10px;margin-top: -30px;"> --element-- <?=$sectionItem['NAME']?> -- <a style="color: green;" href="<?=$sectionItem['URL']?>"><?=$sectionItem['URL']?></a>---- Picture---<img class="mapSitePicture" src="<?=CFile::GetPath($itemResProduct['PREVIEW_PICTURE'])?>"></p>
                                                <?
                                            }
                                        }
