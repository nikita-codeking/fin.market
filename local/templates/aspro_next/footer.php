                                                ...
                                                <noindex>
                                                    <div class="search-tags-cloud" id="ajax-menu">
                                                        ...
                                                        <div class="tags">
                                                            ...
                                                            <a href="/ratings/?section=332" rel="nofollow">Автокредиты</a>
                                                        </div>
                                                    </div>
                                                </noindex>
											<?php endif; ?>
            ...
            window.onload = function () {
                ...
                window.setTimeout(function () {
                    ...
                    document.body.classList.remove('loaded_hiding');
                        ...
                        <script>
                            $('.sidearea .tags a').click(function(){
                                //удаляет у всех актив
                                $('.sidearea .tags a').removeClass('active');
                                //ставит актив по кликнутой
